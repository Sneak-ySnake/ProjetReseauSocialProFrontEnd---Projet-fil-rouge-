    ...
    <div className="CDU">
      <div class="container">
        <div class="row align-items-center my-5">
          ...
          <div>
            <h1 class="font-weight-light">Conditions générales d'utilisation</h1>
            <p>En vigueur au 19/08/2021</p>
            ...
            <p>L’édition et la direction de la publication du site tender_du_poulet.fr est assurée par Venet Phillipe,
            domicilié 28 rue du Char dAssaut.
            Numéro de téléphone est 06 19 39 19 45
            Adresse e-mail philippe.V@gmail.com.
            L'hébergeur du site tender_du_poulet.fr est la société OVH, dont le siège social est situé au 5 rue
            d'OVH, avec le numéro de téléphone : 0123456789.</p>

            <h2>ARTICLE 2 : Accès au site</h2>
            <p>Le site tender_du_poulet.fr permet à l'Utilisateur un accès gratuit aux services suivants :
            ...
            <p>Les sources des informations diffusées sur le site tender_du_poulet.fr sont réputées fiables mais le
            ...
            Malgré des mises à jour régulières, le site tender_du_poulet.fr ne peut être tenu responsable de la
            ...
            ce site.
            Le site tender_du_poulet.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient
            ...
            liens, il sortira du site tender_du_poulet.fr. Ce dernier n’a pas de contrôle sur les pages web sur
            ...
            l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site tender_du_poulet.fr. Les 
            ...
            L’information contenue dans les cookies est utilisée pour améliorer le site tender_du_poulet.fr.
